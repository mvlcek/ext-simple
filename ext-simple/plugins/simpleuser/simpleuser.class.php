...
class SimpleUser extends XmlFile implements User {
  ...
  public function getDisplayName() {
    return (string) $this->root->displayname;
  }
  ...
  public function checkPassword($password) {
    return sha1($this->root->password) == sha1($this->root->username.$this->root->salt.$password);
  }
